...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information of file using file desciptor\n");
    ...
    while(1)
    {
      ...
      else if(count == 3)
      {
             ...
             else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret>=0)
                     printf("File is successfully opened eith file descritor : %d\n",ret);
                if(ret == -1)
                     printf("ERROR : Incorrect parameters\n");
                if(ret == -2)
             ...
             else if(strcmp(command[0],"read") == 0)
            {
                 ...
                 if(fd == -1)
                 {
                       printf("Error : Incorrent parameter\n");
                       continue;
                 } 
